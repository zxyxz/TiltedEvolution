...
struct RequestQuestUpdate final : ClientMessage
{
    ...
    {
        return GetOpcode() == acRhs.GetOpcode() && Id == acRhs.Id && Stage == acRhs.Stage && Status == acRhs.Status && SceneEndFlag == acRhs.SceneEndFlag && ClientQuestType == acRhs.ClientQuestType;
    }
