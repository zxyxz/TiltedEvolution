...
void RequestDroppedItemPhysicsDisabled::SerializeRaw(TiltedPhoques::Buffer::Writer& aWriter) const noexcept
{
...
void RequestDroppedItemPhysicsDisabled::DeserializeRaw(TiltedPhoques::Buffer::Reader& aReader) noexcept
{
